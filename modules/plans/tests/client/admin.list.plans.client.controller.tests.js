(function () {
  ...
  describe('Admin Plans List Controller Tests', function () {
    // Initialize global variables
    var PlansAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _PlansService_) {
      ...
      $httpBackend.whenGET('/modules/plans/client/views/list-plans.client.view.html').respond(200, '');
      ...
      PlansAdminListController = $controller('PlansAdminListController as vm', {
        $scope: $scope
      });
